...
! function() {
    var e = function(e) {
        ...
        function o(e, t) {
            ...
            function n(e, t) {
                var n = 0;
                e && (n = e.indentation_level, !A.just_added_newline() && e.line_indent_level > n && (n = e.line_indent_level));
                return {
                    mode: t,
                    parent: e,
                    ...
                    start_line_index: A.get_line_number(),
                    ternary_depth: 0
                }
            }

            function o(e, t) {
                for (var n = e.newlines, i = z.keep_array_indentation && b(M.mode), r = L, _ = 0; _ < e.comments_before.length; _++) o(L = e.comments_before[_], t), X[L.type](t);
                if (L = r, i)
                    for (var a = 0; a < n; a += 1) E(a > 0, t);
                else if (z.max_preserve_newlines && n > z.max_preserve_newlines && (n = z.max_preserve_newlines), z.preserve_newlines && e.newlines > 1) {
                    E(!1, t);
                    for (var s = 1; s < n; s += 1) E(!0, t)
                }
            }

            function T(e) {
                if (e = void 0 !== e && e, !A.just_added_newline()) {
                    var t = z.preserve_newlines && L.wanted_newline || e;
                    if (r(M.last_text, N.positionable_operators) || r(L.text, N.positionable_operators)) {
                        var n = r(M.last_text, N.positionable_operators) && r(z.operator_position, d) || r(L.text, N.positionable_operators);
                        t = t && n
                    }
                    if (t) E(!1, !0);
                    else if (z.wrap_line_length) {
                        if ("TK_RESERVED" === V && r(M.last_text, G)) return;
                        A.current_line.get_character_count() + L.text.length + (A.space_before_token ? 1 : 0) >= z.wrap_line_length && E(!1, !0)
                    }
                }
            }

            function E(e, t) {
                if (!t && ";" !== M.last_text && "," !== M.last_text && "=" !== M.last_text && "TK_OPERATOR" !== V)
                    for (var n = y(1); !(M.mode !== h.Statement || M.if_block && n && "TK_RESERVED" === n.type && "else" === n.text || M.do_block);) k();
                A.add_new_line(e) && (M.multiline_frame = !0)
            }

            function x() {
                A.just_added_newline() && (z.keep_array_indentation && b(M.mode) && L.wanted_newline ? (A.current_line.push(L.whitespace_before), A.space_before_token = !1) : A.set_indent(M.indentation_level) && (M.line_indent_level = M.indentation_level))
            }

            function R(e) {
                if (A.raw) A.add_raw_token(L);
                else {
                    if (z.comma_first && "TK_COMMA" === V && A.just_added_newline() && "," === A.previous_line.last()) {
                        var t = A.previous_line.pop();
                        A.previous_line.is_empty() && (A.previous_line.push(t), A.trim(!0), A.current_line.pop(), A.trim()), x(), A.add_token(","), A.space_before_token = !0
                    }
                    e = e || L.text, x(), A.add_token(e)
                }
            }

            function K() {
                M.indentation_level += 1
            }

            function m(e) {
                M ? (j.push(M), I = M) : I = n(null, e), M = n(I, e)
            }
            ...
            function v(e) {
                return r(e, [h.Expression, h.ForInitializer, h.Conditional])
            }

            function k() {
                j.length > 0 && (I = M, M = j.pop(), I.mode !== h.Statement || z.unindent_chained_methods || i(A, I))
            }

            function w() {
                return M.parent.mode === h.ObjectLiteral && M.mode === h.Statement && (":" === M.last_text && 0 === M.ternary_depth || "TK_RESERVED" === V && r(M.last_text, ["get", "set"]))
            }

            function O() {
                return !!("TK_RESERVED" === V && r(M.last_text, ["var", "let", "const"]) && "TK_WORD" === L.type || "TK_RESERVED" === V && "do" === M.last_text || "TK_RESERVED" === V && r(M.last_text, G) && !L.wanted_newline || "TK_RESERVED" === V && "else" === M.last_text && ("TK_RESERVED" !== L.type || "if" !== L.text || L.comments_before.length) || "TK_END_EXPR" === V && (I.mode === h.ForInitializer || I.mode === h.Conditional) || "TK_WORD" === V && M.mode === h.BlockStatement && !M.in_case && "--" !== L.text && "++" !== L.text && "function" !== P && "TK_WORD" !== L.type && "TK_RESERVED" !== L.type || M.mode === h.ObjectLiteral && (":" === M.last_text && 0 === M.ternary_depth || "TK_RESERVED" === V && r(M.last_text, ["get", "set"]))) && (m(h.Statement), z.unindent_chained_methods || K(), o(L, !0), w() || T("TK_RESERVED" === L.type && r(L.text, ["do", "for", "if", "while"])), !0)
            }
            ...
            function g() {
                if ("TK_RESERVED" === L.type)
                    if (r(L.text, ["set", "get"]) && M.mode !== h.ObjectLiteral) L.type = "TK_WORD";
                    else if (r(L.text, ["as", "from"]) && !M.import_block) L.type = "TK_WORD";
                else if (M.mode === h.ObjectLiteral) {
                    ":" === y(1).text && (L.type = "TK_WORD")
                }
                if (O() ? "TK_RESERVED" === V && r(M.last_text, ["var", "let", "const"]) && "TK_WORD" === L.type && (M.declaration_statement = !0) : !L.wanted_newline || v(M.mode) || "TK_OPERATOR" === V && "--" !== M.last_text && "++" !== M.last_text || "TK_EQUALS" === V || !z.preserve_newlines && "TK_RESERVED" === V && r(M.last_text, ["var", "let", "const", "set", "get"]) ? o(L) : (o(L), E()), M.do_block && !M.do_while) {
                    if ("TK_RESERVED" === L.type && "while" === L.text) return A.space_before_token = !0, R(), A.space_before_token = !0, void(M.do_while = !0);
                    E(), M.do_block = !1
                }
                if (M.if_block)
                    if (M.else_block || "TK_RESERVED" !== L.type || "else" !== L.text) {
                        for (; M.mode === h.Statement;) k();
                        M.if_block = !1, M.else_block = !1
                    } else M.else_block = !0;
                if ("TK_RESERVED" === L.type && ("case" === L.text || "default" === L.text && M.in_case_statement)) return E(), (M.case_body || z.jslint_happy) && (M.indentation_level > 0 && (!M.parent || M.indentation_level > M.parent.indentation_level) && (M.indentation_level -= 1), M.case_body = !1), R(), M.in_case = !0, void(M.in_case_statement = !0);
                if ("TK_COMMA" !== V && "TK_START_EXPR" !== V && "TK_EQUALS" !== V && "TK_OPERATOR" !== V || w() || T(), "TK_RESERVED" === L.type && "function" === L.text) return (r(M.last_text, ["}", ";"]) || A.just_added_newline() && !r(M.last_text, ["(", "[", "{", ":", "=", ","]) && "TK_OPERATOR" !== V) && (A.just_added_blankline() || L.comments_before.length || (E(), E(!0))), "TK_RESERVED" === V || "TK_WORD" === V ? "TK_RESERVED" === V && (r(M.last_text, ["get", "set", "new", "export", "async"]) || r(M.last_text, G)) ? A.space_before_token = !0 : "TK_RESERVED" === V && "default" === M.last_text && "export" === P ? A.space_before_token = !0 : E() : "TK_OPERATOR" === V || "=" === M.last_text ? A.space_before_token = !0 : (M.multiline_frame || !v(M.mode) && !b(M.mode)) && E(), R(), void(M.last_word = L.text);
                if (W = "NONE", "TK_END_BLOCK" === V ? I.inline_frame ? W = "SPACE" : "TK_RESERVED" === L.type && r(L.text, ["else", "catch", "finally", "from"]) ? "expand" === z.brace_style || "end-expand" === z.brace_style || "none" === z.brace_style && L.wanted_newline ? W = "NEWLINE" : (W = "SPACE", A.space_before_token = !0) : W = "NEWLINE" : "TK_SEMICOLON" === V && M.mode === h.BlockStatement ? W = "NEWLINE" : "TK_SEMICOLON" === V && v(M.mode) ? W = "SPACE" : "TK_STRING" === V ? W = "NEWLINE" : "TK_RESERVED" === V || "TK_WORD" === V || "*" === M.last_text && (r(P, ["function", "yield"]) || M.mode === h.ObjectLiteral && r(P, ["{", ","])) ? W = "SPACE" : "TK_START_BLOCK" === V ? W = M.inline_frame ? "SPACE" : "NEWLINE" : "TK_END_EXPR" === V && (A.space_before_token = !0, W = "NEWLINE"), "TK_RESERVED" === L.type && r(L.text, N.line_starters) && ")" !== M.last_text && (W = M.inline_frame || "else" === M.last_text || "export" === M.last_text ? "SPACE" : "NEWLINE"), "TK_RESERVED" === L.type && r(L.text, ["else", "catch", "finally"]))
                    if (("TK_END_BLOCK" !== V || I.mode !== h.BlockStatement || "expand" === z.brace_style || "end-expand" === z.brace_style || "none" === z.brace_style && L.wanted_newline) && !M.inline_frame) E();
                    else {
                        A.trim(!0);
                        "}" !== A.current_line.last() && E(), A.space_before_token = !0
                    }
                else "NEWLINE" === W ? "TK_RESERVED" === V && S(M.last_text) ? A.space_before_token = !0 : "TK_END_EXPR" !== V ? "TK_START_EXPR" === V && "TK_RESERVED" === L.type && r(L.text, ["var", "let", "const"]) || ":" === M.last_text || ("TK_RESERVED" === L.type && "if" === L.text && "else" === M.last_text ? A.space_before_token = !0 : E()) : "TK_RESERVED" === L.type && r(L.text, N.line_starters) && ")" !== M.last_text && E() : M.multiline_frame && b(M.mode) && "," === M.last_text && "}" === P ? E() : "SPACE" === W && (A.space_before_token = !0);
                R(), M.last_word = L.text, "TK_RESERVED" === L.type && ("do" === L.text ? M.do_block = !0 : "if" === L.text ? M.if_block = !0 : "import" === L.text ? M.import_block = !0 : M.import_block && "TK_RESERVED" === L.type && "from" === L.text && (M.import_block = !1))
            }

            function D(e) {
                if (A.raw) return A.add_raw_token(L), void(L.directives && "end" === L.directives.preserve && (A.raw = z.test_output_raw));
                if (L.directives) return E(!1, e), R(), "start" === L.directives.preserve && (A.raw = !0), void E(!1, !0);
                if (!l.newline.test(L.text) && !L.wanted_newline) return A.space_before_token = !0, R(), void(A.space_before_token = !0);
                var t, n = function(e) {
                        for (var t = [], n = (e = e.replace(l.allLineBreaks, "\n")).indexOf("\n"); - 1 !== n;) t.push(e.substring(0, n)), n = (e = e.substring(n + 1)).indexOf("\n");
                        return e.length && t.push(e), t
                    }(L.text),
                    i = !1,
                    r = !1,
                    o = L.whitespace_before,
                    s = o.length;
                for (E(!1, e), n.length > 1 && (i = function(e, t) {
                        for (var n = 0; n < e.length; n++)
                            if (_(e[n]).charAt(0) !== t) return !1;
                        return !0
                    }(n.slice(1), "*"), r = function(e, t) {
                        for (var n, i = 0, r = e.length; i < r; i++)
                            if ((n = e[i]) && 0 !== n.indexOf(t)) return !1;
                        return !0
                    }(n.slice(1), o)), R(n[0]), t = 1; t < n.length; t++) E(!1, !0), i ? R(" " + a(n[t])) : r && n[t].length > s ? R(n[t].substring(s)) : A.add_token(n[t]);
                E(!1, e)
            }
            var A, C, N, L, V, P, B, M, I, j, W, X, z, F = [],
                U = "";
            X = {
                TK_START_EXPR: function() {
                    ...
                    var e = h.Expression;
                    if ("[" === L.text) {
                        if ("TK_WORD" === V || ")" === M.last_text) return "TK_RESERVED" === V && r(M.last_text, N.line_starters) && (A.space_before_token = !0), m(e), R(), K(), void(z.space_in_paren && (A.space_before_token = !0));
                        e = h.ArrayLiteral, b(M.mode) && ("[" !== M.last_text && ("," !== M.last_text || "]" !== P && "}" !== P) || z.keep_array_indentation || E())
                    } else "TK_RESERVED" === V && "for" === M.last_text ? e = h.ForInitializer : "TK_RESERVED" === V && r(M.last_text, ["if", "while"]) && (e = h.Conditional);
                    ";" === M.last_text || "TK_START_BLOCK" === V ? E() : "TK_END_EXPR" === V || "TK_START_EXPR" === V || "TK_END_BLOCK" === V || "." === M.last_text ? T(L.wanted_newline) : "TK_RESERVED" === V && "(" === L.text || "TK_WORD" === V || "TK_OPERATOR" === V ? "TK_RESERVED" === V && ("function" === M.last_word || "typeof" === M.last_word) || "*" === M.last_text && (r(P, ["function", "yield"]) || M.mode === h.ObjectLiteral && r(P, ["{", ","])) ? z.space_after_anon_function && (A.space_before_token = !0) : "TK_RESERVED" !== V || !r(M.last_text, N.line_starters) && "catch" !== M.last_text || z.space_before_conditional && (A.space_before_token = !0) : A.space_before_token = !0, "(" === L.text && "TK_RESERVED" === V && r(M.last_word, ["await", "async"]) && (A.space_before_token = !0), "(" === L.text && ("TK_EQUALS" !== V && "TK_OPERATOR" !== V || w() || T()), "(" === L.text && "TK_WORD" !== V && "TK_RESERVED" !== V && T(), m(e), R(), z.space_in_paren && (A.space_before_token = !0), K()
                },
                TK_END_EXPR: function() {
                    for (; M.mode === h.Statement;) k();
                    o(L), M.multiline_frame && T("]" === L.text && b(M.mode) && !z.keep_array_indentation), z.space_in_paren && ("TK_START_EXPR" !== V || z.space_in_empty_paren ? A.space_before_token = !0 : (A.trim(), A.space_before_token = !1)), "]" === L.text && z.keep_array_indentation ? (R(), k()) : (k(), R()), i(A, I), M.do_while && I.mode === h.Conditional && (I.mode = h.Expression, M.do_block = !1, M.do_while = !1)
                },
                TK_START_BLOCK: function() {
                    o(L);
                    var e = y(1),
                        t = y(2);
                    m(t && (r(t.text, [":", ","]) && r(e.type, ["TK_STRING", "TK_WORD", "TK_RESERVED"]) || r(e.text, ["get", "set", "..."]) && r(t.type, ["TK_WORD", "TK_RESERVED"])) ? r(P, ["class", "interface"]) ? h.BlockStatement : h.ObjectLiteral : "TK_OPERATOR" === V && "=>" === M.last_text ? h.BlockStatement : r(V, ["TK_EQUALS", "TK_START_EXPR", "TK_COMMA", "TK_OPERATOR"]) || "TK_RESERVED" === V && r(M.last_text, ["return", "throw", "import", "default"]) ? h.ObjectLiteral : h.BlockStatement);
                    var n = !e.comments_before.length && "}" === e.text && "function" === M.last_word && "TK_END_EXPR" === V;
                    if (z.brace_preserve_inline) {
                        var i = 0,
                            _ = null;
                        M.inline_frame = !0;
                        do {
                            if (i += 1, (_ = y(i)).wanted_newline) {
                                M.inline_frame = !1;
                                break
                            }
                        } while ("TK_EOF" !== _.type && ("TK_END_BLOCK" !== _.type || _.opened !== L))
                    }("expand" === z.brace_style || "none" === z.brace_style && L.wanted_newline) && !M.inline_frame ? "TK_OPERATOR" !== V && (n || "TK_EQUALS" === V || "TK_RESERVED" === V && S(M.last_text) && "else" !== M.last_text) ? A.space_before_token = !0 : E(!1, !0) : (!b(I.mode) || "TK_START_EXPR" !== V && "TK_COMMA" !== V || (("TK_COMMA" === V || z.space_in_paren) && (A.space_before_token = !0), ("TK_COMMA" === V || "TK_START_EXPR" === V && M.inline_frame) && (T(), I.multiline_frame = I.multiline_frame || M.multiline_frame, M.multiline_frame = !1)), "TK_OPERATOR" !== V && "TK_START_EXPR" !== V && ("TK_START_BLOCK" !== V || M.inline_frame ? A.space_before_token = !0 : E())), R(), K()
                },
                TK_END_BLOCK: function() {
                    for (o(L); M.mode === h.Statement;) k();
                    var e = "TK_START_BLOCK" === V;
                    M.inline_frame && !e ? A.space_before_token = !0 : "expand" === z.brace_style ? e || E() : e || (b(M.mode) && z.keep_array_indentation ? (z.keep_array_indentation = !1, E(), z.keep_array_indentation = !0) : E()), k(), R()
                },
                TK_WORD: g,
                TK_RESERVED: g,
                TK_SEMICOLON: function() {
                    O() ? A.space_before_token = !1 : o(L);
                    for (var e = y(1); !(M.mode !== h.Statement || M.if_block && e && "TK_RESERVED" === e.type && "else" === e.text || M.do_block);) k();
                    M.import_block && (M.import_block = !1), R()
                },
                TK_STRING: function() {
                    O() ? A.space_before_token = !0 : (o(L), "TK_RESERVED" === V || "TK_WORD" === V || M.inline_frame ? A.space_before_token = !0 : "TK_COMMA" === V || "TK_START_EXPR" === V || "TK_EQUALS" === V || "TK_OPERATOR" === V ? w() || T() : E()), R()
                },
                TK_EQUALS: function() {
                    O() || o(L), M.declaration_statement && (M.declaration_assignment = !0), A.space_before_token = !0, R(), A.space_before_token = !0
                },
                TK_OPERATOR: function() {
                    var e = "*" === L.text && ("TK_RESERVED" === V && r(M.last_text, ["function", "yield"]) || r(V, ["TK_START_BLOCK", "TK_COMMA", "TK_END_BLOCK", "TK_SEMICOLON"])),
                        t = r(L.text, ["-", "+"]) && (r(V, ["TK_START_BLOCK", "TK_START_EXPR", "TK_EQUALS", "TK_OPERATOR"]) || r(M.last_text, N.line_starters) || "," === M.last_text);
                    O() || o(L, !e);
                    if ("TK_RESERVED" === V && S(M.last_text)) return A.space_before_token = !0, void R();
                    if ("*" !== L.text || "TK_DOT" !== V)
                        if ("::" !== L.text) {
                            if ("TK_OPERATOR" === V && r(z.operator_position, d) && T(), ":" === L.text && M.in_case) return M.case_body = !0, K(), R(), E(), void(M.in_case = !1);
                            var n = !0,
                                i = !0,
                                _ = !1;
                            if (":" === L.text ? 0 === M.ternary_depth ? n = !1 : (M.ternary_depth -= 1, _ = !0) : "?" === L.text && (M.ternary_depth += 1), !t && !e && z.preserve_newlines && r(L.text, N.positionable_operators)) {
                                var a = ":" === L.text,
                                    s = a && _,
                                    l = a && !_;
                                switch (z.operator_position) {
                                    case u.before_newline:
                                        return A.space_before_token = !l, R(), a && !s || T(), void(A.space_before_token = !0);
                                    case u.after_newline:
                                        return A.space_before_token = !0, !a || s ? y(1).wanted_newline ? E(!1, !0) : T() : A.space_before_token = !1, R(), void(A.space_before_token = !0);
                                    case u.preserve_newline:
                                        return l || T(), n = !(A.just_added_newline() || l), A.space_before_token = n, R(), void(A.space_before_token = !0)
                                }
                            }
                            if (e) {
                                T(), n = !1;
                                var c = y(1);
                                i = c && r(c.type, ["TK_WORD", "TK_RESERVED"])
                            } else "..." === L.text ? (T(), n = "TK_START_BLOCK" === V, i = !1) : (r(L.text, ["--", "++", "!", "~"]) || t) && (n = !1, i = !1, !L.wanted_newline || "--" !== L.text && "++" !== L.text || E(!1, !0), ";" === M.last_text && v(M.mode) && (n = !0), "TK_RESERVED" === V ? n = !0 : "TK_END_EXPR" === V ? n = !("]" === M.last_text && ("--" === L.text || "++" === L.text)) : "TK_OPERATOR" === V && (n = r(L.text, ["--", "-", "++", "+"]) && r(M.last_text, ["--", "-", "++", "+"]), r(L.text, ["+", "-"]) && r(M.last_text, ["--", "++"]) && (i = !0)), (M.mode !== h.BlockStatement || M.inline_frame) && M.mode !== h.Statement || "{" !== M.last_text && ";" !== M.last_text || E());
                            A.space_before_token = A.space_before_token || n, R(), A.space_before_token = i
                        } else R();
                    else R()
                },
                TK_COMMA: function() {
                    o(L, !0), R(), A.space_before_token = !0, M.declaration_statement ? (v(M.parent.mode) && (M.declaration_assignment = !1), M.declaration_assignment ? (M.declaration_assignment = !1, E(!1, !0)) : z.comma_first && T()) : M.mode === h.ObjectLiteral || M.mode === h.Statement && M.parent.mode === h.ObjectLiteral ? (M.mode === h.Statement && k(), M.inline_frame || E()) : z.comma_first && T()
                },
                TK_BLOCK_COMMENT: D,
                TK_COMMENT: function(e) {
                    L.wanted_newline ? E(!1, e) : A.trim(!0), A.space_before_token = !0, R(), E(!1, e)
                },
                TK_DOT: function() {
                    O() || o(L, !0), "TK_RESERVED" === V && S(M.last_text) ? A.space_before_token = !0 : T(")" === M.last_text && z.break_chained_methods), R()
                },
                TK_UNKNOWN: function(e) {
                    R(), "\n" === L.text[L.text.length - 1] && E(!1, e)
                },
                TK_EOF: function() {
                    for (; M.mode === h.Statement;) k();
                    o(L)
                }
            }, t = s(t = t || {}, "js"), z = {}, "expand-strict" === t.brace_style ? t.brace_style = "expand" : "collapse-preserve-inline" === t.brace_style ? t.brace_style = "collapse,preserve-inline" : void 0 !== t.braces_on_own_line ? t.brace_style = t.braces_on_own_line ? "expand" : "collapse" : t.brace_style || (t.brace_style = "collapse");
            var Q = t.brace_style.split(/[^a-zA-Z0-9_\-]+/);
            z.brace_preserve_inline = !1, z.brace_style = "collapse";
            for (var $ = 0; $ < Q.length; $++) "preserve-inline" === Q[$] ? z.brace_preserve_inline = !0 : z.brace_style = Q[$];
            for (z.indent_size = t.indent_size ? parseInt(t.indent_size, 10) : 4, z.indent_char = t.indent_char ? t.indent_char : " ", z.eol = t.eol ? t.eol : "auto", z.preserve_newlines = void 0 === t.preserve_newlines || t.preserve_newlines, z.unindent_chained_methods = void 0 !== t.unindent_chained_methods && t.unindent_chained_methods, z.break_chained_methods = void 0 !== t.break_chained_methods && t.break_chained_methods, z.max_preserve_newlines = void 0 === t.max_preserve_newlines ? 0 : parseInt(t.max_preserve_newlines, 10), z.space_in_paren = void 0 !== t.space_in_paren && t.space_in_paren, z.space_in_empty_paren = void 0 !== t.space_in_empty_paren && t.space_in_empty_paren, z.jslint_happy = void 0 !== t.jslint_happy && t.jslint_happy, z.space_after_anon_function = void 0 !== t.space_after_anon_function && t.space_after_anon_function, z.keep_array_indentation = void 0 !== t.keep_array_indentation && t.keep_array_indentation, z.space_before_conditional = void 0 === t.space_before_conditional || t.space_before_conditional, z.unescape_strings = void 0 !== t.unescape_strings && t.unescape_strings, z.wrap_line_length = void 0 === t.wrap_line_length ? 0 : parseInt(t.wrap_line_length, 10), z.e4x = void 0 !== t.e4x && t.e4x, z.end_with_newline = void 0 !== t.end_with_newline && t.end_with_newline, z.comma_first = void 0 !== t.comma_first && t.comma_first, z.operator_position = function(e) {
                    if (e = e || u.before_newline, !r(e, f)) throw new Error("Invalid Option Value: The option 'operator_position' must be one of the following values\n" + f + "\nYou passed in: '" + e + "'");
                    return e
                }(t.operator_position), z.test_output_raw = void 0 !== t.test_output_raw && t.test_output_raw, z.jslint_happy && (z.space_after_anon_function = !0), t.indent_with_tabs && (z.indent_char = "\t", z.indent_size = 1), "auto" === z.eol && (z.eol = "\n", e && l.lineBreak.test(e || "") && (z.eol = e.match(l.lineBreak)[0])), z.eol = z.eol.replace(/\\r/, "\r").replace(/\\n/, "\n"), B = ""; z.indent_size > 0;) B += z.indent_char, z.indent_size -= 1;
            var Z = 0;
            if (e && e.length) {
                for (;
                    " " === e.charAt(Z) || "\t" === e.charAt(Z);) Z += 1;
                U = e.substring(0, Z), e = e.substring(Z)
            }
            V = "TK_START_BLOCK", P = "", (A = new c(B, U)).raw = z.test_output_raw, j = [], m(h.BlockStatement), this.beautify = function() {
                for (N = new p(e, z, B), F = N.tokenize(), C = 0, L = y(); L;) X[L.type](), P = M.last_text, V = L.type, M.last_text = L.text, C += 1, L = y();
                return A.get_code(z.end_with_newline, z.eol)
            };
            var G = ["break", "continue", "return", "throw", "yield"]
        }
        var s = n(3).mergeOpts,
            l = n(0),
            c = n(4).Output,
            p = n(7).Tokenizer,
            f = ["before-newline", "after-newline", "preserve-newline"],
            u = function(e) {
        ...
        function r(e, t) {
            function n() {
                ...
                u = 0, d = "";
                var w = E.next();
                if (null === w) return ["", "TK_EOF"];
                var O;
                for (O = T.length ? T[T.length - 1] : new a("TK_START_BLOCK", "{"); i(w, r);)
                    if (o.newline.test(w) ? "\n" === w && "\r" === E.peek(-2) || (u += 1, n = []) : n.push(w), null === (w = E.next())) return ["", "TK_EOF"];
                if (n.length && (d = n.join("")), s.test(w) || "." === w && E.testChar(s)) {
                    var S = !0,
                        y = !0,
                        g = s;
                    for ("0" === w && E.testChar(/[XxOoBb]/) ? (S = !1, y = !1, g = E.testChar(/[Bb]/) ? l : E.testChar(/[Oo]/) ? c : p, w += E.next()) : "." === w ? S = !1 : (w = "", E.back()); E.testChar(g);) w += E.next(), S && "." === E.peek() && (w += E.next(), S = !1), y && E.testChar(/[Ee]/) && (w += E.next(), E.testChar(/[+-]/) && (w += E.next()), y = !1, S = !1);
                    return [w, "TK_WORD"]
                }
                if (o.isIdentifierStart(E.peekCharCode(-1))) {
                    if (E.hasNext())
                        for (; o.isIdentifierChar(E.peekCharCode()) && (w += E.next(), E.hasNext()););
                    return "TK_DOT" === O.type || "TK_RESERVED" === O.type && i(O.text, ["set", "get"]) || !i(w, x) ? [w, "TK_WORD"] : "in" === w || "of" === w ? [w, "TK_OPERATOR"] : [w, "TK_RESERVED"]
                }
                if ("(" === w || "[" === w) return [w, "TK_START_EXPR"];
                if (")" === w || "]" === w) return [w, "TK_END_EXPR"];
                if ("{" === w) return [w, "TK_START_BLOCK"];
                if ("}" === w) return [w, "TK_END_BLOCK"];
                if (";" === w) return [w, "TK_SEMICOLON"];
                if ("/" === w) {
                    var D, A = "";
                    if ("*" === E.peek()) {
                        E.next();
                        var C = function(e) {
                            if (!e.match(m)) return null;
                            var t = {};
                            b.lastIndex = 0;
                            for (var n = b.exec(e); n;) t[n[1]] = n[2], n = b.exec(e);
                            return t
                        }(A = "/*" + (D = E.match(R))[0]);
                        return C && "start" === C.ignore && (A += (D = E.match(v))[0]), A = A.replace(o.allLineBreaks, "\n"), [A, "TK_BLOCK_COMMENT", C]
                    }
                    if ("/" === E.peek()) return E.next(), D = E.match(K), A = "//" + D[0], [A, "TK_COMMENT"]
                }
                var N = /<()([-a-zA-Z:0-9_.]+|{[\s\S]+?}|!\[CDATA\[[\s\S]*?\]\])(\s+{[\s\S]+?}|\s+[-a-zA-Z:0-9_.]+|\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{[\s\S]+?}))*\s*(\/?)\s*>/g;
                if ("`" === w || "'" === w || '"' === w || ("/" === w || t.e4x && "<" === w && E.test(N, -1)) && ("TK_RESERVED" === O.type && i(O.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === O.type && ")" === O.text && O.parent && "TK_RESERVED" === O.parent.type && i(O.parent.text, ["if", "while", "for"]) || i(O.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var L = w,
                        V = !1,
                        P = !1;
                    if (e = w, "/" === L)
                        for (var B = !1; E.hasNext() && (V || B || E.peek() !== L) && !E.testChar(o.newline);) e += E.peek(), V ? V = !1 : (V = "\\" === E.peek(), "[" === E.peek() ? B = !0 : "]" === E.peek() && (B = !1)), E.next();
                    else if (t.e4x && "<" === L) {
                        ...
                        var I = "",
                            j = E.match(N);
                        if (j) {
                            for (var W = j[2].replace(/^{\s+/, "{").replace(/\s+}$/, "}"), X = 0 === W.indexOf("{"), z = 0; j;) {
                                var F = !!j[1],
                                    U = j[2];
                                if (!(!!j[j.length - 1] || "![CDATA[" === U.slice(0, 8)) && (U === W || X && U.replace(/^{\s+/, "{").replace(/\s+}$/, "}")) && (F ? --z : ++z), I += j[0], z <= 0) break;
                                j = E.match(M)
                            }
                            return j || (I += E.match(/[\s\S]*/g)[0]), I = I.replace(o.allLineBreaks, "\n"), [I, "TK_STRING"]
                        }
                    } else {
                        var Q = function(t, n, i) {
                            for (var r; E.hasNext() && (r = E.peek(), V || r !== t && (n || !o.newline.test(r)));)(V || n) && o.newline.test(r) ? ("\r" === r && "\n" === E.peek(1) && (E.next(), r = E.peek()), e += "\n") : e += r, V ? ("x" !== r && "u" !== r || (P = !0), V = !1) : V = "\\" === r, E.next(), i && -1 !== e.indexOf(i, e.length - i.length) && ("`" === t ? Q("}", n, "`") : Q("`", n, "${"), E.hasNext() && (e += E.next()))
                        };
                        "`" === L ? Q("`", !0, "${") : Q(L)
                    }
                    if (P && t.unescape_strings && (e = function(e) {
                            var t = "",
                                n = 0,
                                i = new _(e),
                                r = null;
                            for (; i.hasNext();)
                                if ((r = i.match(/([\s]|[^\\]|\\\\)+/g)) && (t += r[0]), "\\" === i.peek()) {
                                    if (i.next(), "x" === i.peek()) r = i.match(/x([0-9A-Fa-f]{2})/g);
                                    else {
                                        if ("u" !== i.peek()) {
                                    ...
                                    if (!r) return e;
                                    if ((n = parseInt(r[1], 16)) > 126 && n <= 255 && 0 === r[0].indexOf("x")) return e;
                                    if (n >= 0 && n < 32) {
                                        t += "\\" + r[0];
                                        continue
                                    }
                            ...
                            return t
                        }(e)), E.peek() === L && (e += L, E.next(), "/" === L))
                        for (; E.hasNext() && o.isIdentifierStart(E.peekCharCode());) e += E.next();
                    return [e, "TK_STRING"]
                }
                if ("#" === w) {
                    if (0 === T.length && "!" === E.peek()) {
                        for (e = w; E.hasNext() && "\n" !== w;) w = E.next(), e += w;
                        return [function(e) {
                            return e.replace(/^\s+|\s+$/g, "")
                        }(e) + "\n", "TK_UNKNOWN"]
                    ...
                    var $ = "#";
                    if (E.hasNext() && E.testChar(s)) {
                        do {
                            $ += w = E.next()
                        } while (E.hasNext() && "#" !== w && "=" !== w);
                        return "#" === w || ("[" === E.peek() && "]" === E.peek(1) ? ($ += "[]", E.next(), E.next()) : "{" === E.peek() && "}" === E.peek(1) && ($ += "{}", E.next(), E.next())), [$, "TK_WORD"]
                    }
                }
                if ("<" === w && ("?" === E.peek() || "%" === E.peek())) {
                    E.back();
                    var Z = E.match(k);
                    if (Z) return w = Z[0], w = w.replace(o.allLineBreaks, "\n"), [w, "TK_STRING"]
                }
                if ("<" === w && E.match(/\!--/g)) {
                    for (w = "\x3c!--"; E.hasNext() && !E.testChar(o.newline);) w += E.next();
                    return h = !0, [w, "TK_COMMENT"]
                }
                if ("-" === w && h && E.match(/->/g)) return h = !1, ["--\x3e", "TK_COMMENT"];
                if ("." === w) return "." === E.peek() && "." === E.peek(1) ? (w += E.next() + E.next(), [w, "TK_OPERATOR"]) : [w, "TK_DOT"];
                if (i(w, f)) {
                    for (; E.hasNext() && i(w + E.peek(), f) && (w += E.next(), E.hasNext()););
            ...
            var u, d, h, T, E, x = this.line_starters.concat(["do", "in", "of", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await", "from", "as"]),
                R = /([\s\S]*?)((?:\*\/)|$)/g,
                K = /([^\n\r\u2028\u2029]*)/g,
                m = /\/\* beautify( \w+[:]\w+)+ \*\//g,
                b = / (\w+)[:](\w+)/g,
                v = /([\s\S]*?)((?:\/\*\sbeautify\signore:end\s\*\/)|$)/g,
                k = /((<\?php|<\?=)[\s\S]*?\?>)|(<%[\s\S]*?%>)/g;
            this.tokenize = function() {
                E = new _(e), h = !1, T = [];
                for (var t, i, r, o = null, s = [], l = []; !i || "TK_EOF" !== i.type;) {
                    for (r = n(), t = new a(r[1], r[0], u, d);
                        "TK_COMMENT" === t.type || "TK_BLOCK_COMMENT" === t.type || "TK_UNKNOWN" === t.type;) "TK_BLOCK_COMMENT" === t.type && (t.directives = r[2]), l.push(t), r = n(), t = new a(r[1], r[0], u, d);
                    l.length && (t.comments_before = l, l = []), "TK_START_BLOCK" === t.type || "TK_START_EXPR" === t.type ? (t.parent = i, s.push(o), o = t) : ("TK_END_BLOCK" === t.type || "TK_END_EXPR" === t.type) && o && ("]" === t.text && "[" === o.text || ")" === t.text && "(" === o.text || "}" === t.text && "{" === o.text) && (t.parent = o.parent, t.opened = o, o = s.pop()), T.push(t), i = t
                }
                return T
            }
        }
        var _ = n(2).InputScanner,
            a = n(5).Token,
            o = n(0);
        e.exports.Tokenizer = r
    }]);
